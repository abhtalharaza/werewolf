...
import { MessageSquare, Moon, Skull, ScrollText, Send, ChevronDown, ChevronUp } from 'lucide-react';
...
export const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div
      id="chat-panel"
      className="flex flex-col bg-zinc-950/90 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-md w-full"
    >
      {/* Header & Tabs */}
      ...
      {!isCollapsed && (
        <>
          {/* Message List */}
          <div className={`flex-1 p-3 sm:p-3.5 overflow-y-auto space-y-2.5 text-xs ${
            isMobileTab ? 'min-h-[300px] max-h-[58vh]' : 'max-h-[260px] min-h-[140px]'
          }`}>
